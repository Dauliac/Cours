...
radar_visualization({
  ...
  entries: [
    ...
    { label: "Vale", quadrant: 1, ring: 1, moved: 0, link: "https://vale.sh/" },
    { label: "markdownlint", quadrant: 1, ring: 1, moved: 0, link: "https://github.com/DavidAnson/markdownlint" },
    { label: "lychee", quadrant: 1, ring: 0, moved: 0, link: "https://lychee.cli.rs/" },
    { label: "anybadge", quadrant: 1, ring: 1, moved: 0, link: "https://github.com/jongracecox/anybadge" },
    { label: "Jupyter Notebook", quadrant: 1, ring: 1, moved: 0, link: "https://jupyter.org/" },
    { label: "tokei", quadrant: 1, ring: 1, moved: 0, link: "https://github.com/XAMPPRocky/tokei" },
    { label: "reveal.js", quadrant: 1, ring: 1, moved: 0, link: "https://revealjs.com/" },
    { label: "mq", quadrant: 1, ring: 1, moved: 0, link: "https://mqlang.org/" },
    { label: "Pandoc", quadrant: 1, ring: 0, moved: 0, link: "https://pandoc.org/" },
    { label: "Typst", quadrant: 1, ring: 1, moved: 0, link: "https://typst.app/" },
    { label: "Asciidoctor", quadrant: 1, ring: 1, moved: 0, link: "https://asciidoctor.org/" },
    { label: "Sphinx", quadrant: 1, ring: 1, moved: 0, link: "https://www.sphinx-doc.org/" },
    { label: "MkDocs", quadrant: 1, ring: 1, moved: 0, link: "https://www.mkdocs.org/" },
    { label: "Hugo", quadrant: 1, ring: 1, moved: 0, link: "https://gohugo.io/" },
    { label: "Zola", quadrant: 1, ring: 1, moved: 0, link: "https://www.getzola.org/" },
    { label: "Slides", quadrant: 1, ring: 1, moved: 0, link: "https://github.com/maaslalani/slides" },
    { label: "Jupyter Book", quadrant: 1, ring: 1, moved: 0, link: "https://jupyterbook.org/" },
    ...
    // Tools — Observability & Monitoring
    { label: "OpenTelemetry", quadrant: 1, ring: 0, moved: 0, link: "https://opentelemetry.io/" },
    { label: "Grafana", quadrant: 1, ring: 0, moved: 0, link: "https://grafana.com/" },
    { label: "Prometheus", quadrant: 1, ring: 0, moved: 0, link: "https://prometheus.io/" },
    { label: "Vector", quadrant: 1, ring: 0, moved: 0, link: "https://vector.dev/" },
    { label: "Grafana Loki", quadrant: 1, ring: 0, moved: 0, link: "https://grafana.com/oss/loki/" },
    { label: "Grafana Tempo", quadrant: 1, ring: 1, moved: 0, link: "https://grafana.com/oss/tempo/" },
    { label: "Grafana Mimir", quadrant: 1, ring: 1, moved: 0, link: "https://grafana.com/oss/mimir/" },
    { label: "Grafana Alloy", quadrant: 1, ring: 1, moved: 0, link: "https://grafana.com/docs/alloy/" },
    { label: "Jaeger", quadrant: 1, ring: 1, moved: 0, link: "https://www.jaegertracing.io/" },
    { label: "Pyroscope", quadrant: 1, ring: 1, moved: 0, link: "https://pyroscope.io/" },
    { label: "VictoriaMetrics", quadrant: 1, ring: 1, moved: 0, link: "https://victoriametrics.com/" },
    { label: "Datadog", quadrant: 1, ring: 1, moved: 0, link: "https://www.datadoghq.com/" },
    { label: "Fluentd", quadrant: 1, ring: 2, moved: 0, link: "https://www.fluentd.org/" },
    { label: "Logstash", quadrant: 1, ring: 3, moved: 0, link: "https://www.elastic.co/logstash" },
    { label: "ClickHouse", quadrant: 1, ring: 1, moved: 0, link: "https://clickhouse.com/" },
    { label: "Quickwit", quadrant: 1, ring: 1, moved: 0, link: "https://quickwit.io/" },
    { label: "OpenObserve", quadrant: 1, ring: 2, moved: 0, link: "https://openobserve.ai/" },
    { label: "SigNoz", quadrant: 1, ring: 1, moved: 0, link: "https://signoz.io/" },
    { label: "Elasticsearch", quadrant: 1, ring: 2, moved: 0, link: "https://www.elastic.co/elasticsearch" },
    { label: "OpenSearch", quadrant: 1, ring: 2, moved: 0, link: "https://opensearch.org/" },
    ...
    { label: "MCP", quadrant: 3, ring: 0, moved: 0, link: "https://modelcontextprotocol.io/" },
    { label: "AGENTS.md", quadrant: 3, ring: 0, moved: 0, link: "https://docs.anthropic.com/en/docs/claude-code/agents-md" },
    ...
    { label: "zstd", quadrant: 3, ring: 0, moved: 0, link: "https://facebook.github.io/zstd/" },
    { label: "Apache Parquet", quadrant: 3, ring: 0, moved: 0, link: "https://parquet.apache.org/" },
    { label: "Apache Arrow", quadrant: 3, ring: 1, moved: 0, link: "https://arrow.apache.org/" },
